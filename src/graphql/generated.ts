...
export type GetLessonBySlugQuery = {
  __typename?: 'Query', lesson?: {
    videoId: string; __typename?: 'Lesson', title: string, id: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, name: string, avatarURL: string } | null
  } | null
};
